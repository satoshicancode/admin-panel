...
export const EditInventoryItemForm = ({ item }: EditInventoryItemFormProps) => {
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="inventory-edit-item-form"
    >
      <KeyboundForm
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="inventory-edit-item-form-body"
        >
          <Form.Field
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-form-title-item">
                  <Form.Label data-testid="inventory-edit-item-form-title-label">
                    {t('fields.title')}
                  </Form.Label>
                  <Form.Control data-testid="inventory-edit-item-form-title-control">
                    <div data-testid="inventory-edit-item-form-title-input-wrapper">
                      <Input
                        {...field}
                        data-testid="inventory-edit-item-form-title-input"
                      />
                    </div>
                  </Form.Control>
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-form-sku-item">
                  <Form.Label data-testid="inventory-edit-item-form-sku-label">
                    {t('fields.sku')}
                  </Form.Label>
                  <Form.Control data-testid="inventory-edit-item-form-sku-control">
                    <div data-testid="inventory-edit-item-form-sku-input-wrapper">
                      <Input
                        {...field}
                        data-testid="inventory-edit-item-form-sku-input"
                      />
                    </div>
                  </Form.Control>
        ...
        <RouteDrawer.Footer data-testid="inventory-edit-item-form-footer">
          <div
            ...
            data-testid="inventory-edit-item-form-footer-actions"
          >
            <RouteDrawer.Close
              asChild
              data-testid="inventory-edit-item-form-cancel-button-wrapper"
            >
              <Button
                variant="secondary"
                size="small"
                data-testid="inventory-edit-item-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              size="small"
              isLoading={isLoading}
              data-testid="inventory-edit-item-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
