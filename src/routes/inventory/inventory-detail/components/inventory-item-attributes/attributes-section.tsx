...
export const InventoryItemAttributeSection = ({
  ...
  return (
    <Container
      ...
      data-testid="inventory-item-attribute-section"
    >
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid="inventory-item-attribute-header"
      >
        <Heading
          level="h2"
          data-testid="inventory-item-attribute-title"
        >
