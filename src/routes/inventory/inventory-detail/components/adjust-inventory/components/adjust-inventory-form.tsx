...
export const AdjustInventoryForm = ({ item, level, location }: AdjustInventoryFormProps) => {
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="inventory-adjust-inventory-form"
    >
      <KeyboundForm
      ...
      >
        <RouteDrawer.Body
          className="flex flex-1 flex-col gap-y-8 overflow-auto"
          data-testid="inventory-adjust-inventory-form-body"
        >
          <div
            className="grid grid-rows-4 divide-y rounded-lg border text-ui-fg-subtle shadow-elevation-card-rest"
            data-testid="inventory-adjust-inventory-form-info-grid"
          >
            <AttributeGridRow
            ...
            render={({ field: { onChange, value, ...field } }) => {
              return (
                <Form.Item data-testid="inventory-adjust-inventory-form-stocked-quantity-item">
                  <Form.Label data-testid="inventory-adjust-inventory-form-stocked-quantity-label">
                    {t('fields.inStock')}
                  </Form.Label>
        ...
        <RouteDrawer.Footer data-testid="inventory-adjust-inventory-form-footer">
          <div
            ...
            data-testid="inventory-adjust-inventory-form-footer-actions"
          >
            <RouteDrawer.Close
              asChild
              data-testid="inventory-adjust-inventory-form-cancel-button-wrapper"
            >
              <Button
                variant="secondary"
                size="small"
                data-testid="inventory-adjust-inventory-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              size="small"
              isLoading={isLoading}
              data-testid="inventory-adjust-inventory-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
