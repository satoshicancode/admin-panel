...
export const EditInventoryItemAttributesForm = ({ item }: EditInventoryItemAttributeFormProps) => {
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="inventory-edit-item-attributes-form"
    >
      <KeyboundForm
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="inventory-edit-item-attributes-form-body"
        >
          <Form.Field
            ...
            render={({ field: { onChange, value, ...field } }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-height-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-height-label"
                  >
                    {t('fields.height')}
                  </Form.Label>
            ...
            render={({ field: { onChange, value, ...field } }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-width-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-width-label"
                  >
                    {t('fields.width')}
                  </Form.Label>
            ...
            render={({ field: { onChange, value, ...field } }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-length-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-length-label"
                  >
                    {t('fields.length')}
                  </Form.Label>
            ...
            render={({ field: { onChange, value, ...field } }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-weight-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-weight-label"
                  >
                    {t('fields.weight')}
                  </Form.Label>
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-mid-code-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-mid-code-label"
                  >
                    {t('fields.midCode')}
                  </Form.Label>
                  <Form.Control data-testid="inventory-edit-item-attributes-form-mid-code-control">
                    <div data-testid="inventory-edit-item-attributes-form-mid-code-input-wrapper">
                      <Input
                        {...field}
                        data-testid="inventory-edit-item-attributes-form-mid-code-input"
                      />
                    </div>
                  </Form.Control>
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-hs-code-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-hs-code-label"
                  >
                    {t('fields.hsCode')}
                  </Form.Label>
                  <Form.Control data-testid="inventory-edit-item-attributes-form-hs-code-control">
                    <div data-testid="inventory-edit-item-attributes-form-hs-code-input-wrapper">
                      <Input
                        {...field}
                        data-testid="inventory-edit-item-attributes-form-hs-code-input"
                      />
                    </div>
                  </Form.Control>
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-material-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-material-label"
                  >
                    {t('fields.material')}
                  </Form.Label>
                  <Form.Control data-testid="inventory-edit-item-attributes-form-material-control">
                    <div data-testid="inventory-edit-item-attributes-form-material-input-wrapper">
                      <Input
                        {...field}
                        data-testid="inventory-edit-item-attributes-form-material-input"
                      />
                    </div>
                  </Form.Control>
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="inventory-edit-item-attributes-form-origin-country-item">
                  <Form.Label
                    optional
                    data-testid="inventory-edit-item-attributes-form-origin-country-label"
                  >
                  ...
                  <Form.Control data-testid="inventory-edit-item-attributes-form-origin-country-control">
                    <div data-testid="inventory-edit-item-attributes-form-origin-country-select-wrapper">
                      <CountrySelect
                        {...field}
                        data-testid="inventory-edit-item-attributes-form-origin-country-select"
                      />
                    </div>
                  </Form.Control>
        ...
        <RouteDrawer.Footer data-testid="inventory-edit-item-attributes-form-footer">
          <div
            ...
            data-testid="inventory-edit-item-attributes-form-footer-actions"
          >
            <RouteDrawer.Close
              asChild
              data-testid="inventory-edit-item-attributes-form-cancel-button-wrapper"
            >
              <Button
                variant="secondary"
                size="small"
                data-testid="inventory-edit-item-attributes-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              size="small"
              isLoading={isLoading}
              data-testid="inventory-edit-item-attributes-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
