      ...
      >
        ...
        >
          <RouteFocusModal.Header data-testid="inventory-create-form-header">
            <ProgressTabs.List
              className="-my-2 ml-2 min-w-0 flex-1 border-l border-ui-border-base"
              data-testid="inventory-create-form-tabs-list"
            >
          ...
          >
            ...
            >
              <div
                className="mx-auto flex w-full max-w-[720px] flex-col gap-y-8 px-px py-16"
                data-testid="inventory-create-form-content"
              >
                <div className="flex flex-col gap-y-8">
                  <div data-testid="inventory-create-form-header">
                    <Heading data-testid="inventory-create-form-heading">
                        ...
                        render={({ field }) => {
                          return (
                            <Form.Item data-testid="inventory-create-form-title-item">
                              <Form.Label data-testid="inventory-create-form-title-label">
                                {t('fields.title')}
                              </Form.Label>
                        ...
                        render={({ field }) => {
                          return (
                            <Form.Item data-testid="inventory-create-form-sku-item">
                              <Form.Label data-testid="inventory-create-form-sku-label">
                                {t('fields.sku')}
                              </Form.Label>
                              <Form.Control data-testid="inventory-create-form-sku-control">
                                <Input
                                  {...field}
                                  placeholder="sku-123"
                                  data-testid="inventory-create-form-sku-input"
                                />
                              </Form.Control>
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-description-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-description-label"
                            >
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-width-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-width-label"
                            >
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-length-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-length-label"
                            >
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-height-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-height-label"
                            >
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-weight-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-weight-label"
                            >
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-mid-code-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-mid-code-label"
                            >
                            ...
                            <Form.Control data-testid="inventory-create-form-mid-code-control">
                              <Input
                                {...field}
                                data-testid="inventory-create-form-mid-code-input"
                              />
                            </Form.Control>
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-hs-code-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-hs-code-label"
                            >
                            ...
                            <Form.Control data-testid="inventory-create-form-hs-code-control">
                              <Input
                                {...field}
                                data-testid="inventory-create-form-hs-code-input"
                              />
                            </Form.Control>
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-origin-country-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-origin-country-label"
                            >
                            ...
                            <Form.Control data-testid="inventory-create-form-origin-country-control">
                              <CountrySelect
                                {...field}
                                data-testid="inventory-create-form-origin-country-select"
                              />
                            </Form.Control>
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="inventory-create-form-material-item">
                            <Form.Label
                              optional
                              data-testid="inventory-create-form-material-label"
                            >
                            ...
                            <Form.Control data-testid="inventory-create-form-material-control">
                              <Input
                                {...field}
                                data-testid="inventory-create-form-material-input"
                              />
                            </Form.Control>
            ...
            <div className="flex items-center justify-end gap-x-2">
              <RouteFocusModal.Close asChild>
                <Button
                  variant="secondary"
                  size="small"
                  data-testid="inventory-create-form-cancel-button"
                >
                  {t('actions.cancel')}
                </Button>
              ...
              <Button
                ...
                data-testid={
                  tab === Tab.AVAILABILITY
                    ? 'inventory-create-form-save-button'
                    : 'inventory-create-form-next-button'
                }
              >
