...
export function EditServiceZoneAreasForm({
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="location-service-zone-manage-areas-form"
    >
      <KeyboundForm
      ...
      >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="location-service-zone-manage-areas-form-body"
        >
          <StackedFocusModal
            id={GEO_ZONE_STACKED_MODAL_ID}
            data-testid="location-service-zone-manage-areas-form-stacked-modal"
          >
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                variant="secondary"
                size="small"
                data-testid="location-service-zone-manage-areas-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              size="small"
              isLoading={isLoading}
              data-testid="location-service-zone-manage-areas-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
