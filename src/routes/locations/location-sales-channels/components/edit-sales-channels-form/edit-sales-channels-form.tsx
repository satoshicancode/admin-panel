...
import { useSalesChannels, useUpdateStockLocationSalesChannels } from '@hooks/api';
...
export const LocationEditSalesChannelsForm = ({ location }: EditSalesChannelsFormProps) => {
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="location-sales-channels-form"
    >
      <KeyboundForm
      ...
      >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="location-sales-channels-form-body"
        >
          <DataTable
            data={sales_channels}
            columns={columns}
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                ...
                variant="secondary"
                type="button"
                data-testid="location-sales-channels-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              type="submit"
              data-testid="location-sales-channels-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
