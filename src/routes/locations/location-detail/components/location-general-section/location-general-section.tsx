...
import { getFormattedAddress } from '@lib/addresses.ts';
import { countries as staticCountries, type StaticCountry } from '@lib/data/countries.ts';
...
import { FulfillmentSetType, ShippingOptionPriceType } from '@routes/locations/common/constants.ts';
