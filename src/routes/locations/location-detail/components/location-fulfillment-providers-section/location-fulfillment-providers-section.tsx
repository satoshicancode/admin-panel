...
function LocationsFulfillmentProvidersSection({
  ...
  return (
    <Container
      ...
      data-testid="location-fulfillment-providers-section-container"
    >
      <div
        className="flex items-center justify-between"
        data-testid="location-fulfillment-providers-section-header"
      >
        <Heading
          level="h2"
          data-testid="location-fulfillment-providers-section-heading"
        >
      ...
      {fulfillment_providers?.length ? (
        <div
          ...
          data-testid="location-fulfillment-providers-section-content"
        >
          <div
            className="grid grid-cols-[28px_1fr] items-center gap-x-3 gap-y-3"
            data-testid="location-fulfillment-providers-section-list"
          >
            {fulfillment_providers?.map(fulfillmentProvider => {
              return (
                <Fragment key={fulfillmentProvider.id}>
                  <IconAvatar
                    data-testid={`location-fulfillment-providers-section-provider-icon-${fulfillmentProvider.id}`}
                  >
                  ...
                  <div
                    ...
                    data-testid={`location-fulfillment-providers-section-provider-name-${fulfillmentProvider.id}`}
                  >
