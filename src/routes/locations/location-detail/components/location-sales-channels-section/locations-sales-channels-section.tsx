...
function LocationsSalesChannelsSection({ location }: LocationsSalesChannelsSectionProps) {
  ...
  return (
    <Container
      ...
      data-testid="location-sales-channels-section-container"
    >
      <div
        className="flex items-center justify-between"
        data-testid="location-sales-channels-section-header"
      >
        <Heading
          level="h2"
          data-testid="location-sales-channels-section-heading"
        >
      ...
      {hasConnectedChannels ? (
        <div
          ...
          data-testid="location-sales-channels-section-content"
        >
          <div
            className="grid grid-cols-[28px_1fr] items-center gap-x-3"
            data-testid="location-sales-channels-section-list"
          >
          ...
          <Text
            ...
            size="small"
            leading="compact"
            data-testid="location-sales-channels-section-description"
          >
