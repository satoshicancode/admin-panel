    ...
    >
      ...
      >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="location-create-form-body"
        >
            ...
            <div className="flex w-full max-w-[720px] flex-col gap-y-8 px-2 py-16">
              <div data-testid="location-create-form-header-section">
                <Heading
                  ...
                  data-testid="location-create-form-heading"
                >
                ...
                <Text
                  ...
                  data-testid="location-create-form-hint"
                >
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-name-item">
                      <Form.Label data-testid="location-create-form-name-label">
                        {t('fields.name')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-name-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-name-input"
                        />
                      </Form.Control>
              ...
              <div
                ...
                data-testid="location-create-form-address-fields"
              >
                <Form.Field
                  control={form.control}
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-address-1-item">
                      <Form.Label data-testid="location-create-form-address-1-label">
                        {t('fields.address')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-address-1-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-address-1-input"
                        />
                      </Form.Control>
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-address-2-item">
                      <Form.Label
                        optional
                        data-testid="location-create-form-address-2-label"
                      >
                        {t('fields.address2')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-address-2-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-address-2-input"
                        />
                      </Form.Control>
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-postal-code-item">
                      <Form.Label
                        optional
                        data-testid="location-create-form-postal-code-label"
                      >
                        {t('fields.postalCode')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-postal-code-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-postal-code-input"
                        />
                      </Form.Control>
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-city-item">
                      <Form.Label
                        optional
                        data-testid="location-create-form-city-label"
                      >
                        {t('fields.city')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-city-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-city-input"
                        />
                      </Form.Control>
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-country-item">
                      <Form.Label data-testid="location-create-form-country-label">
                        {t('fields.country')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-country-control">
                        <CountrySelect
                          {...field}
                          data-testid="location-create-form-country-input"
                        />
                      </Form.Control>
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-province-item">
                      <Form.Label
                        optional
                        data-testid="location-create-form-province-label"
                      >
                        {t('fields.state')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-province-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-province-input"
                        />
                      </Form.Control>
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-company-item">
                      <Form.Label
                        optional
                        data-testid="location-create-form-company-label"
                      >
                        {t('fields.company')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-company-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-company-input"
                        />
                      </Form.Control>
                ...
                <Form.Field
                  ...
                  render={({ field }) => (
                    <Form.Item data-testid="location-create-form-phone-item">
                      <Form.Label
                        optional
                        data-testid="location-create-form-phone-label"
                      >
                        {t('fields.phone')}
                      </Form.Label>
                      <Form.Control data-testid="location-create-form-phone-control">
                        <Input
                          size="small"
                          {...field}
                          data-testid="location-create-form-phone-input"
                        />
                      </Form.Control>
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="location-create-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              size="small"
              isLoading={isPending}
              data-testid="location-create-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
