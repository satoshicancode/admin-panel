...
export const EditServiceZoneForm = ({
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="location-service-zone-edit-form"
    >
      <KeyboundForm
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="location-service-zone-edit-form-body"
        >
          <div className="flex flex-col gap-y-8">
                ...
                render={({ field }) => {
                  return (
                    <Form.Item data-testid="location-service-zone-edit-form-name-item">
                      <Form.Label data-testid="location-service-zone-edit-form-name-label">
                        {t('fields.name')}
                      </Form.Label>
                      <Form.Control data-testid="location-service-zone-edit-form-name-control">
                        <Input
                          {...field}
                          data-testid="location-service-zone-edit-form-name-input"
                        />
                      </Form.Control>
            ...
            <InlineTip
              label={t('general.tip')}
              data-testid="location-service-zone-edit-form-tip"
            >
          ...
          <div className="flex items-center gap-x-2">
            <RouteDrawer.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="location-service-zone-edit-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              type="submit"
              isLoading={isLoading}
              data-testid="location-service-zone-edit-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
